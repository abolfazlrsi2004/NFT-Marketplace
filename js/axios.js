  ...
  return `
    ...
    <div class="overflow-hidden rounded-20">
      ...
      <div class="grid grid-cols-3 gap-4">
        ...
        <div class="hover:bg-sed bg-primary grid  w-full cursor-pointer place-items-center rounded-20 md:px-3 xl:px-4 py-8 font-mono text-2xl font-bold text-white transition-all duration-300">
    ...
    <div class="bg-background-secondary relative w-[315px] gap-5  md:w-[330px] h-[100px] xl:h-60 xl:w-60 rounded-20 flex flex-row xl:flex-col ${responsiveClass}">
      ...
      <div class=" mb-0.5 xl:mb-0 gap-1  flex flex-col py-5 xl:pt-0 pr-5 xl:px-5">
        ...
        <div class="flex gap-5 ">
          <span class="text-Caption text-base">Total Sales:</span>
          <span class="font-mono text-base text-white">${creator.total_sales} ${creator.currency}</span>
        </div>
      </div>

      <div class="text-Caption bg-background-primary absolute top-3.25 left-3  xl:top-5 xl:left-4.5 grid h-7.5 w-7.5 place-items-center rounded-full">
        ${index + 1}
      </div>
    </div>
  `;
...
const renderCategoryCard = (category) => {
  return `
    <div class="flex flex-col xl:max-w-60   xl:h-max h-58 ;">
      ...
      <div class="bg-background-secondary h-22 pt-5 pb-11 px-5 rounded-b-20">
...
const renderNFTCard = (nft, creator, index) => {
  ...
  return `
    <section class="max-w-82.5  ${visibilityClasses}">
      ...
      <div class="w-82.5   overflow-hidden rounded-t-20">
        <img 
          src="${nft.image}" 
          alt="${nft.name}" 
      ...
      <div class="bg-background-secondary flex w-[330px] flex-col gap-5 rounded-b-20">
